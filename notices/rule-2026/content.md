...
이번 khuthon 2026과 관련하여 대회 규정을 공고하오니 참고해주시기 바랍니다.<br>
...
- 참가자는 '참가 등록'과 '현장 등록'을 완료하고 발표 시간 및 시상식과 폐회식(이하 대회 후반)에 참석하고 있는 사람으로 한다.
- '현장 등록'은 5월 8일 21시에 마감한다. '현장 등록'을 하지 않은 팀원은 수상자에서 제외한다.
- 참가 확인증과 기념품은 참가자를 대상으로 지급하는 것을 원칙으로 한다.
- 발표 등록을 하지 않은 팀은 전원 참가하지 않은 것으로 본다. 단, 대회 후반을 참여할 경우 참가 확인증과 기념품은 지급한다.
...
- 다음 사례에 해당하는 경우 불참자로 분류되더라도 불이익은 면제한다. 이 경우 현장에서 참가 정도를 판단하여 참가 확인증과 기념품을 지급할 수 있다.
...
- 다음 사례에 해당하는 경우 현장 운영진 허가를 받아 대회 후반에도 중도이탈할 수 있으며 참가자로 볼 수 있다.
  - 대회가 지연이나 천재지변 등으로 인해 5월 9일 13시까지 종료하지 못한 경우
  - 중간고사 등 학교에서 이루어지는 시험에 응시하는 경우. 단, 사유가 해소될 때까지 대회가 종료되지 않았다면 즉시 복귀하여야 한다.
  - 부상 등으로 진료를 받아야 하는 경우 또는 대회 중간에 실신·심정지·사망한 경우
  - 기타 학칙에서 인정하거나, 불가피한 사정으로 현장 운영진 다수가 동의할 만한 사유가 있는 경우
...
- 산출물을 시연하지 않은 경우에는 산출물과 관련된 점수를 0점으로 한다.
  ...
  - 미완성 시연은 관련 점수가 낮아질 수는 있더라도 시연한 것으로 본다.
  - 영상 시연은 현장 운영진 2인 이상이 동의할 만한 이유가 있는 경우에만 인정한다. 이 경우 영상 시연 대상은 최소화해야 하며, 영상 시연과 일반 시연을 병행할 수 있다.
...
- 참가자는 자신의 노트북을 모니터에 연결하여 발표해야 한다. 단, IoT·모바일·햅틱스 장비 등 별도의 기기를 추가로 사용하여 시연할 수 있다.

### 기타 사항 관련

- 참가 확인증은 대회 종료 이후 이메일로 제공한다.
- 대회 중에는 전자기기를 반출할 수 없다.
...
- 스태프는 사전 개발이나 외부 도움이 의심되는 경우 메신저 로그나 깃 등 VCS 로그를 요청할 수 있다.
  - 무분별한 요청을 방지하기 위해, 메신저 로그 요청은 최소 2인 이상의 운영진이 동의해야 한다.
  - 정당한 사유를 가진 요청을 거절할 경우 부정행위를 한 것으로 본다.
  - 공식 문서 확인, 온라인 검색, 공개 자료 사용, 생성형 AI 사용, StackOverflow 질문, 오픈소스 사용 등 일반적인 개발 및 기획 과정에서 이루어지는 상호작용은 외부 도움으로 보지 않는다.
  - 코드뿐만 아니라 지인에게 의견을 자문받는 등 아이디어를 포함하여 전 영역에서 외부 도움이 없어야 한다.
  - 환경 세팅, 보일러플레이트 사용 등 일반적인 관점에서 사전 개발이라고 보지 않을 합당한 사유가 있는 수준의 작업은 사전 개발로 보지 아니한다. 이 경우 입증 책임은 참가자에게 있다.
